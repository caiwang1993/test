(function () {
    ...
    Mdate.prototype = {
        ...
        createDateUi: function () {
            var str = "" + '<section class="getDateBg">' + '<section class="getDateBox" id="getDateBox">' + '<div class="choiceDateTitle">' + '<button id="dateCancel">取消</button>' + '<button id="dateSure" class="fr">确定</button>' + "</div>" + '<div class="dateContent">' + '<div class="checkeDate"></div>' + '<div id="yearwrapper">' + '<ul id="yearUl"></ul>' + "</div>" + '<div id="monthwrapper">' + '<ul id="monthUl"></ul>' + "</div>" + '<div id="daywrapper">' + '<ul id="dayUl"></ul>' + "</div>" + "</div>" + "</section>" + "</section>";
        ...
        refreshScroll: function() {
            ...
            var initValArr = initVal != "" ? that.acceptId.value.replace(/[\u4e00-\u9fa5]/g,"-").split("-") : [];
