;(function($, window, document, undefined) {
    ...
    var _height = outerWidth >= middleWidth ? 380 : 145;
    var _slideHeight = outerWidth >= middleWidth ? 330 : 145;
    ...
    Carousel.prototype = {
        ...
        initalCarousel: function() {
            ...
            for (var i = 0; i < half_imgLen; i++) {
                ...
                if (k == 0) {
                    this.$aImg.eq(leftNum).css({
                        // transform: 'translateX(' + (-200 * (i + 1)) + 'px) translateZ(-120px)',
                        transform: 'translateX(-103.5%) translateZ(-120px)',
                        width:"85%",
                    }).animate({
                    ...
                    this.$aNav.eq(rightNum).attr('onclick', null);
                    k++;
                } else {
                    this.$aImg.eq(leftNum).css({
            ...
            this.$aImg.eq(this.curDisplay).css({
                transform: 'translateX(8%) translateZ(0px)',
                zIndex:99999
            }).animate({
                height: _height + 'px',
            ...
            this.$aNav.eq(this.curDisplay).css({
