(function () {
    ...
    Mdate.prototype = {
        ...
        createDateUi: function () {
            var str = "" + '<section class="getDateBg">' + '<section class="getDateBox" id="getDateBox">' + '<div class="choiceDateTitle">' + '<button id="dateCancel">cancel</button>' + '<button id="dateSure" class="fr">ok</button>' + "</div>" + '<div class="dateContent">' + '<div class="checkeDate"></div>' + '<div id="yearwrapper">' + '<ul id="yearUl"></ul>' + "</div>" + '<div id="monthwrapper">' + '<ul id="monthUl"></ul>' + "</div>" + '<div id="daywrapper">' + '<ul id="dayUl"></ul>' + "</div>" + "</div>" + "</section>" + "</section>";
        ...
        refreshScroll: function() {
            ...
            /*var newInitValArr =initVal.replace(/[\u4e00-\u9fa5]/g,"-")
             console.log(newInitValArr)*/
            /*var initValArr = initVal != "" ? that.acceptId.value.split(that.format) : [];*/
             var initValArr = initVal != "" ? that.acceptId.value.split("-") : [];
            var inputYear,inputMonth,inputDay;
            console.log(initValArr);
            if(initValArr.length>0){
                inputYear  = initValArr[0];
                inputMonth = initValArr[1];
        ...
        dateSure: function () {
            ...
            sureBtn.onclick = function () {
                if (that.format == "YMD") {
                    that.acceptId.value = yearTag + "-" + monthTag
                    /*that.acceptId.value = yearTag + "year" + monthTag + "月" + dayTag + "日"*/
                } else {
